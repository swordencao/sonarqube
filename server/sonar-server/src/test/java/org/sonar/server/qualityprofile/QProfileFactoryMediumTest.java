...
public class QProfileFactoryMediumTest {
  ...
  public void checkAndCreate() {
    ...
    assertThat(writtenDto.getKey()).isNotNull();
  ...
  @Test
  public void rename() {
    QualityProfileDto dto = factory.checkAndCreate(dbSession, organization, new QProfileName("xoo", "P1"));
    dbSession.commit();
    dbSession.clearCache();
  ...
  public void fail_renaming_if_name_already_exists() {
    QualityProfileDto p1 = factory.checkAndCreate(dbSession, organization, new QProfileName("xoo", "P1"));
    QualityProfileDto p2 = factory.checkAndCreate(dbSession, organization, new QProfileName("xoo", "P2"));
    dbSession.commit();
    dbSession.clearCache();
